...
-- 菜单:  联赛球队管理(2090) 挂载在 球队管理(2088) 下
...
-- 菜单: 联赛球队管理(2090, 菜单C) + 4个按钮(2091-2094, 按钮F), 幂等(INSERT IGNORE)
...
VALUES
(2090, '联赛球队管理', 2088, 3, 'league', 'league/team/index', '', 1, 0, 'C', '0', '0', 'league:team:list', 'peoples', 'admin', sysdate(), '', NULL, '联赛球队管理菜单'),
(2091, '联赛球队查询', 2090, 1, '', '', '', 1, 0, 'F', '0', '0', 'league:team:query', '#', 'admin', sysdate(), '', NULL, ''),
(2092, '联赛球队新增', 2090, 2, '', '', '', 1, 0, 'F', '0', '0', 'league:team:add', '#', 'admin', sysdate(), '', NULL, ''),
(2093, '联赛球队修改', 2090, 3, '', '', '', 1, 0, 'F', '0', '0', 'league:team:edit', '#', 'admin', sysdate(), '', NULL, ''),
(2094, '联赛球队删除', 2090, 4, '', '', '', 1, 0, 'F', '0', '0', 'league:team:remove', '#', 'admin', sysdate(), '', NULL, '');

-- 回显验证
SELECT menu_id, menu_name, parent_id, perms, component FROM sys_menu WHERE menu_id IN (2090, 2091, 2092, 2093, 2094);
